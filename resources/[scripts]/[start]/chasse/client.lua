    ...
    while true do
       ...
       playerPed = GetPlayerPed(-1)
		...
		if pos then
				...
				if (GetDistanceBetweenCoords(GetEntityCoords(GetPlayerPed(-1)), -1492.2, 4971.5, 64.2, true) <= 2 ) then
					DrawMarker(1,-1492.2, 4971.5, 62.8, 0, 0, 0, 0, 0, 0, 2.001, 2.0001, 0.5001, 0, 155, 255, 200, 0, 0, 0, 0)
					drawTxt("Appuyez sur ~b~E~s~ pour commencer/arreter la chasse",0,1,0.5,0.8,0.6,255,255,255,255)
