Locales['fr'] = {
  ...
  ['move_out_sold'] = 'Vendre votre propriété pour: <span style="color:green;">$%s</span>',
  ...
  ['rent'] = 'Achetez la propriété pour <span style="color:green;">$%s</span> / Semaines',
  ...
  ['paid_rent'] = 'Vous avez payez : ~g~$%s~s~ pour ~y~%s~s~',
  ['paid_rent_evicted'] = 'Vous avez été ~o~expulsé~s~ from ~y~%s~s~ ~g~$%s~s~',
