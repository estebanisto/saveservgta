...
function AddMenuDiversMenu(menu)
	...
	local Description4 = "Mettre la vue avec couleurs amplifiées"
	local Description5 = "Activer le GPS"
	local Description6 = "Désactiver votre GPS"
	...
	local couleursItem = NativeUI.CreateItem(('Vue avec couleurs amplifiées'), Description4)
	...
	local gps2Item = NativeUI.CreateItem(('Désactiver le GPS'), Description6)
