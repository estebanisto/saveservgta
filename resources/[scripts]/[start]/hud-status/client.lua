		...
		if rdy then
			...
			--	drawTxt3(1.049, 0.963, 1.0,1.0,0.40 , "" .."🛡" ,255, 255, 255, 255) 
             --   drawTxt3(1.068, 0.963, 1.0,1.0,0.50 , "" ..math.ceil(armor).."", 255, 255, 255, 255) 
		     	...
		     	drawTxt3(1.138, 0.016, 1.0,0.5,0.28 , "" .."🥖" ,255, 255, 255, 255) 
				drawTxt3(1.158, 0.017, 1.0,1.0,0.28 , "" ..math.ceil(faimVal) .. "", 255, 255, 255, 255) 

				drawTxt3(1.135, 0.045, 1.0,1.0,0.28 , "" .."💧" ,255, 255, 255, 255) 
				drawTxt3(1.158, 0.048, 1.0,1.0,0.28 , "" ..math.ceil(soifVal) .. " ", 255, 255, 255, 255) 
