Config = {
    ...
    Items = {
        ...
        --["snacks"] = {
          --  {label = "Chips fromage", item = "cheesebows", price = 20},
            --{label = "Chips barbecue", item = "chips", price = 15},
        --},
        ["readymeal"] = {
            {label = "Pain", item = "bread", price = 7},
        },
        ["diverse"] = {
            {label = "Eau", item = "water", price = 7},
            {label = "Pain", item = "bread", price = 7},
            {label = "Téléphone", item = "phone", price = 150},
            {label = "GPS", item = "gps", price = 20},
            {label = "Croquettes", item = "croquettes", price = 200},
