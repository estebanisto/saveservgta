local Keys = {
	  ...
	  while true do
		  ...
		  for k in pairs(Config.MarkerZones) do
			  if havebike == false then
				  DrawMarker(2, Config.MarkerZones[k].x, Config.MarkerZones[k].y, Config.MarkerZones[k].z, 0, 0, 0, 0, 0, 0, 1.00, 1.00, 1.00, 255, 255, 255, 100, 0, 0, 0, 0)	
			  elseif havebike == true then
				  DrawMarker(2, Config.MarkerZones[k].x, Config.MarkerZones[k].y, Config.MarkerZones[k].z, 0, 0, 0, 0, 0, 0, 1.00, 1.00, 1.00, 255, 0, 0, 100, 0, 0, 0, 0)
			  end
  ...
  function OpenBikesMenu()
	  ...
	  if Config.EnablePrice == false then
		  ...
		  table.insert(elements, {label = 'Scooter', value = 'faggio3'}) 
	  end
