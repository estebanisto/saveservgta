...
AddEventHandler('esx_bikerjob:hasEnteredEntityZone', function(entity)
  ...
  if (PlayerData.job ~= nil and PlayerData.job.name == 'biker') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker') and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'biker') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker') then
      ...
      for k,v in pairs(Config.BikerStations) do
		...
		if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker' and PlayerData.job2.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'biker' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'biker_actions') and (GetGameTimer() - GUI.Time) > 150 then
     OpenBikerActionsMenu()
     GUI.Time = GetGameTimer()
    end
