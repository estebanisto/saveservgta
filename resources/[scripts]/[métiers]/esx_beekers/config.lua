...
Config.Zones = {
	...
	beekersActions = {
		Pos   = { x = 98.77, y = 6620.104, z = 31.650 },
	...
	Craft = {
		Pos   = { x = 110.856, y = 6628.085, z = 30.887 },
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 150, g = 204, b = 155 },
		Type  = 27,
	},

	VehicleSpawnPoint = {
		Pos   = { x = 111.154, y = 6604.174, z = 31.91 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = 120.011, y = 6595.019, z = 31.20 },
