Locales['fr'] = {
  ...
  ['billing'] = 'Mettre une facture',  
  -- Phone
  ['alert_ambulance'] = 'alerte Ambulance',
  -- Death
  ['please_wait'] = 'Vous êtes blessé pour ~b~%s minutes %s seconds~s~\n',
  ['press_respawn'] = 'Appuyez [~b~E~w~] pour respawn.',
  ['respawn_now_fine'] = 'Respawn pour ~g~$%s ~w~[Appuyez ~b~E~w~]',
  ['respawn_fine'] = 'tu as payé ~r~$%s~s~ to respawn.',
  ['distress_send'] = 'Appuyez [~b~G~s~] pour envoyé un signal !',
  ['distress_sent'] = 'le signal de détresse a été envoyé aux unités disponibles !',
  ['distress_message'] = 'signal de détresse a attiré l\'attention médicale requise: citoyen inconscient ! envoyé aux unités disponibles !',
  -- Revive
