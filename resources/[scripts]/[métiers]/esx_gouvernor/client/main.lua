                    ...
                    if Config.MaxInService ~= -1 then
                        ESX.TriggerServerCallback('esx_service:isInService', function(isInService)
                            if isInService then
                                ...
                                TriggerServerEvent('esx_service:notifyAllInService', notification, 'gouvernor')

                                TriggerServerEvent('esx_service:disableService', 'gouvernor', PlayerData.identifier)
                                ESX.ShowNotification(_U('service_out'))
                            end
                        end, 'gouvernor', PlayerData.identifier)
                    end
                end
                        ...
                        ESX.UI.Menu.Open(
                                ...
                                function(data3, menu)
                                    for i = 1, #elements, 1 do
                                        if Config.MaxInService == -1 then
                                            ESX.Game.SpawnVehicle(data3.current.value, Config.Zones.HelicoSpawnPoint.Pos, 291.0, function(vehicle)
                                                -- direction du spawn
...
function OpenGouvernorMenu()
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gouvernor', {
        css = 'unknownstory',
        title = _U('gouvernor'),
        align = 'top-left',
        elements = elements
        ...
        if data.current.value == 'boss_actions' then
            TriggerEvent('esx_society:openBossMenu', 'gouvernor', function(data2, menu2)
                menu.close()
            end)
        elseif data.current.value == 'inventory' then
            OpenRoomMenu(_U('gouvernor'))
        end
...
function OpenTpHelico()
    SetEntityCoords(PlayerPedId(), Config.Zones.HelicoInside.Pos.x, Config.Zones.HelicoInside.Pos.y, Config.Zones.HelicoInside.Pos.z)
end

function OpenExitHelico()
    SetEntityCoords(PlayerPedId(), Config.Zones.HelicoOutside.Pos.x, Config.Zones.HelicoOutside.Pos.y, Config.Zones.HelicoOutside.Pos.z)
end


AddEventHandler('esx_gouverneur:hasEnteredMarker', function(zone)
    if zone == 'CloakRoom' and PlayerData.job.name == 'gouvernor' then
        CurrentAction = 'cloakroom_menu'
        CurrentActionMsg = _U('press_to_access')
        CurrentActionData = {}
    end
    if zone == 'OfficeActions' and PlayerData.job.name == 'gouvernor' then
        CurrentAction = 'gouvernor_menu'
        CurrentActionMsg = _U('press_to_access')
        CurrentActionData = {}
    end
    if zone == 'CarGarage' and PlayerData.job.name == 'gouvernor' then
        CurrentAction = 'garage'
        CurrentActionMsg = 'Entrée du garage'
        CurrentActionData = {}
    end
    ------ Helicoptère
    if zone == 'HelicoEnter' then
    ...
    if zone == 'HelicoSpawner' and PlayerData.job.name == 'gouvernor' then
        CurrentAction = 'helico_spawner_menu'
        CurrentActionMsg = _U('helico_spawn')
        CurrentActionData = {}
    end
    if zone == 'HelicoDeleter' and PlayerData.job.name == 'gouvernor' then
...
Citizen.CreateThread(function()
    ...
    TriggerServerEvent("esx_gouverneur:addPlayer", PlayerData.job.name)
    while true do
        Citizen.Wait(0)
        if CurrentAction ~= nil then
            ESX.ShowHelpNotification(CurrentActionMsg)
            if IsControlPressed(0, Keys['E']) and PlayerData.job ~= nil then
                if CurrentAction == 'garage' and PlayerData.job.name == 'gouvernor' then
...
function StoreNearbyVehicle(playerCoords)
    ...
    ESX.TriggerServerCallback('esx_gouvernor:storeNearbyVehicle', function(storeSuccess, foundNum)
...
function OpenShopMenu(elements, restoreCoords, shopCoords)
    local playerPed = PlayerPedId()
    isInShopMenu = true
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'gouvvehicle_shop', {
        css = 'unknownstory',
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm',
                {
                    ...
                    if data2.current.value == 'yes' then
                        ...
                        ESX.TriggerServerCallback('esx_gouvernor:buyJobVehicle', function(bought)
                            if bought then
...
function OpenGetStocksMenu()
    ...
    ESX.TriggerServerCallback('gouvernor:getStockItems', function(inventory)
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
                {
                    ...
                    if data.current.type == 'item_standard' then
                        ...
                        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
                            ...
                            if count == nil then
                                ...
                                menu2.close()
                                menu.close()
                                TriggerServerEvent('gouvernor:getStockItem', data.current.type, itemName, count)
                    ...
                    elseif data.current.type == 'item_weapon' then
                        ...
                        TriggerServerEvent('gouvernor:getStockItem', data.current.type, data.current.value, data.current.ammo)
...
function OpenPutStocksMenu()
    ...
    ESX.TriggerServerCallback('gouvernor:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
                {
                    ...
                    if data.current.type == 'item_standard' then
                        ...
                        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
                            ...
                            if count == nil then
                                ...
                                menu2.close()
                                menu.close()
                                TriggerServerEvent('gouvernor:putStockItems', data.current.type, itemName, count)
                    ...
                    elseif data.current.type == 'item_weapon' then
                        menu.close()
                        TriggerServerEvent('gouvernor:putStockItems', data.current.type, data.current.value, data.current.ammo)
