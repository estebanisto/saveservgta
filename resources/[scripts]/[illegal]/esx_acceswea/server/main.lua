...
ESX.RegisterServerCallback('esx_acceswea:requestDBItems', function(source, cb)
	if not hasSqlRun then
...
RegisterServerEvent('esx_acceswea:buyItem')
AddEventHandler('esx_acceswea:buyItem', function(itemName, amount, zone)
	...
	if amount < 0 then
		print('esx_acceswea: ' .. xPlayer.identifier .. ' attempted to exploit the shop!')
		return
	end
...
RegisterServerEvent('esx_acceswea:remove')
AddEventHandler('esx_acceswea:remove', function()
	local xPlayer = ESX.GetPlayerFromId(source)
	xPlayer.removeInventoryItem('clip', 1)
end)

ESX.RegisterUsableItem('clip', function(source)
	TriggerClientEvent('esx_acceswea:clipcli', source)
end)

ESX.RegisterUsableItem('silencieux', function(source)
    local xPlayer = ESX.GetPlayerFromId(source)	
    TriggerClientEvent('esx_acceswea:silencieux', source)
...
ESX.RegisterUsableItem('flashlight', function(source)
    ...
    TriggerClientEvent('esx_acceswea:flashlight', source)
...
ESX.RegisterUsableItem('grip', function(source)
    ...
    TriggerClientEvent('esx_acceswea:grip', source)
...
ESX.RegisterUsableItem('yusuf', function(source)
    ...
    TriggerClientEvent('esx_acceswea:yusuf', source)
