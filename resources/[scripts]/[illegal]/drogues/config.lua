...
Config.CircleZones = {
	...
	--License
	LicenseShop = {coords = vector3(690.624, -1013.476, -221.673), name = _U('blip_lsdprocessing'),color = 25, sprite = 496, radius = 20.0},
	
	--MoneyWash
	MoneyWash = {coords = vector3(8.84, -1103.8, -1299.8), name = _U('blip_drugdealer'), color = 6, sprite = 378, radius = 25.0},
}
