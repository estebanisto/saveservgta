...
Config.Marker = {
	r = 100, g = 200, b = 255, a = 100,  -- red color
...
Stores = {
	["paleto_twentyfourseven"] = {
		...
		reward = math.random(12500, 42500),
